        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <h1 class="fw-bolder mt-6 text-xl font-semibold text-gray-900 dark:text-white" style=>
                        DevStation</h1>
                </div>
...
<?php endif; ?>
                    <?php if(auth()->user()->is_admin): ?> <!-- hide that frome the frontend if it's not authorized -->
                        <a class="'inline-flex items-center px-1 pb-10 border-b-2 border-indigo-400 dark:border-indigo-600 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
                        : inline-flex items-center px-1 pt-10 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-700 focus:outline-none focus:text-gray-700 dark:focus:text-gray-300 focus:border-gray-300 dark:focus:border-gray-700 transition duration-150 ease-in-out"
                        href="<?php echo e(route("complaints")); ?>">Complaints</a>
                    <?php endif; ?>
                    <?php if(!auth()->user()->is_manger && !auth()->user()->is_admin): ?> <!-- hide that frome the frontend if it's not authorized -->
                        <a class="'inline-flex items-center px-1 pb-10 border-b-2 border-indigo-400 dark:border-indigo-600 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
                        : inline-flex items-center px-1 pt-10 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-700 focus:outline-none focus:text-gray-700 dark:focus:text-gray-300 focus:border-gray-300 dark:focus:border-gray-700 transition duration-150 ease-in-out"
                        href="<?php echo e(route('createcomplaints')); ?>">write Complaints</a>
                    <?php endif; ?>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Devstation\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>